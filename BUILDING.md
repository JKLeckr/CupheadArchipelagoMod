...
- [native-websocket-sharp](https://github.com/JKLeckr/native-websocket-sharp). Note that it must be the net35 windows version (even on Wine/Proton). For the macOS version of the game, get the net35 macOS version.

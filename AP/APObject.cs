...
namespace CupheadArchipelago.AP {
    ...
    public class APItem : APObject {
        ...
        public static readonly APItem healthupgrade = new APItem(12905179);
        public static readonly APItem weapon_peashooter = new APItem(12905180);
        public static readonly APItem weapon_spread = new APItem(12905181);
        public static readonly APItem weapon_chaser = new APItem(12905182);
        public static readonly APItem weapon_lobber = new APItem(12905183);
        public static readonly APItem weapon_charge = new APItem(12905184);
        public static readonly APItem weapon_roundabout = new APItem(12905185);
        public static readonly APItem charm_heart = new APItem(12905186);
        public static readonly APItem charm_smokebomb = new APItem(12905187);
        public static readonly APItem charm_psugar = new APItem(12905188);
        public static readonly APItem charm_coffee = new APItem(12905189);
        public static readonly APItem charm_twinheart = new APItem(12905190);
        public static readonly APItem charm_whetstone = new APItem(12905191);
        public static readonly APItem super_i = new APItem(12905192);
        public static readonly APItem super_ii = new APItem(12905193);
        public static readonly APItem super_iii = new APItem(12905194);
        public static readonly APItem plane_super = new APItem(12905195);
        ...
        public static readonly APItem weapon_dlc_crackshot = new APItem(12909268);
        public static readonly APItem weapon_dlc_converge = new APItem(12909269);
        public static readonly APItem weapon_dlc_twistup = new APItem(12909270);
        public static readonly APItem charm_dlc_cookie = new APItem(12909271);
        public static readonly APItem charm_dlc_heartring = new APItem(12909272);
        public static readonly APItem charm_dlc_broken_relic = new APItem(12909273);
        public static readonly APItem super_dlc_c_i = new APItem(12909274);
        public static readonly APItem super_dlc_c_ii = new APItem(12909275);
        public static readonly APItem super_dlc_c_iii = new APItem(12909276);
        public static readonly APItem dlc_cplane_super = new APItem(12909277);
